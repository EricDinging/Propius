...
from propius_controller.job_manager.jm_monitor import JM_monitor
from propius_controller.job_manager.jm_db_portal import JM_job_db_portal
...
class Job_manager(propius_pb2_grpc.Job_managerServicer):
    def __init__(self, gconfig: dict, logger: Propius_logger):
        ...
        self.jm_monitor = JM_monitor(logger, gconfig["job_manager_plot_path"], gconfig["plot"])
        self.logger = logger
