...
def set_client_manager_db(propius_data, redis_data, config_data, propius_compose_data):
...
set_client_manager_db(propius_data, redis_data, config_data, propius_compose_data)
