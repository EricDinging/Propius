...
class Root_parameter_serverStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GET = channel.unary_unary(
            "/propius_parameter_server.Root_parameter_server/GET",
        ...
        self.PUSH = channel.unary_unary(
            "/propius_parameter_server.Root_parameter_server/PUSH",
            request_serializer=parameter__server__pb2.job.SerializeToString,
            response_deserializer=parameter__server__pb2.ack.FromString,
        )


class Root_parameter_serverServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_Root_parameter_serverServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "propius_parameter_server.Root_parameter_server", rpc_method_handlers
    )
    server.add_generic_rpc_handlers((generic_handler,))


# This class is part of an EXPERIMENTAL API.
class Root_parameter_server(object):
    """Missing associated documentation comment in .proto file."""
